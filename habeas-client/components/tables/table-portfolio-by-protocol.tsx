...
interface TablePortfolioByProtocolProps {
  address: string;
}

export default function TablePortfolioByProtocol({ address }: TablePortfolioByProtocolProps) {
  ...
  const tableData: TableDataEntry[] = Object.entries(protocolDictionary).map(([name, value]) => ({
    name,
